...
export const AppImages = {
	...
	OnboardingDark1: require('./onboarding/onboarding-dark-1.png') as number,
	OnboardingDark2: require('./onboarding/onboarding-dark-2.png') as number,
	OnboardingDark3: require('./onboarding/onboarding-dark-3.png') as number,
} as const
